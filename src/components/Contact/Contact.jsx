...
<div className='flex flex-col items-center lg:items-start'>
    ...
    <div className='flex flex-col lg:items-start justify-center items-center'>
        ...
        <a href="https://linkedin.com/in/sandhali-gupta-82470325a" rel='noreferrer' target='_blank'><FaLinkedin className='text-xl  text-[#909294] hover:text-[#3B5998]' /></a>
                 <a href="https://twitter.com/ChauhanShahad03" rel='noreferrer' target='_blank'><FaXTwitter className='text-xl  text-[#909294] hover:text-[#3CAEDB]'/></a>
...
<div>
    <h1 className='text-white text-2xl flex justify-center lg:justify-start font-semibold'>SEND US A NOTE</h1>
    <form action="" className='flex flex-col gap-6 justify-center items-center mt-5'>
    <div className='flex gap-6 lg:flex-row flex-col'>
    <input  className='bg-[#343A40] border-none focus:shadow-md  focus:shadow-blue-600  focus:outline outline-offset-0 outline-blue-600 rounded text-lg text-white  h-12 w-80 p-4' type="text" placeholder='Name' />
    <input className='bg-[#343A40] border-none focus:shadow-md  focus:shadow-blue-600  focus:outline outline-offset-0 outline-blue-600 rounded text-lg text-white h-12 w-80 p-4' type="text" placeholder='Email' />
    </div>
    <input className='bg-[#343A40]  rounded text-lg  h-40 w-full p-4 border-none focus:shadow-md  focus:shadow-blue-600  focus:outline outline-offset-0 outline-blue-600 text-white text-start ' type="text" placeholder='Tell us more about your needs here......' />
