...
function Home() {
  return (
    <div className=" bg-cover  w-[100%] h-[50rem] md:h-[40rem] flex justify-center items-center overflow-hidden  "
        style={{ backgroundImage: `url(${Comp})`}} >
     <div className='flex flex-col gap-5 justify-center  items-center md:ml-[13.5rem] '>
    <p className='text-white md:text-3xl  text-2xl bold'>Welcome</p>
    <p className='text-white md:text-[4rem] text-4xl font-bold ' >I am a Designer</p>
