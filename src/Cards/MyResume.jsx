...
function MyResume(props) {
  return (
    <div className='min-h-[13rem] w-[21rem] lg:w-[28rem] bg-[#111418] rounded p-4 flex flex-col justify-around gap-5'>
        <div className='text-white flex flex-col gap-3 '>
            <p className='bg-[#F7B900] w-fit px-2 rounded font-normal '> {props.year}</p>
